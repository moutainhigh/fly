...
package com.hsd.oa.service.activity;
...
public class ProcessInstanceHighlightsResource {
  ...
  @Autowired
	...
	@RequestMapping(value="/diagram-viewer/service/process-instance/{processInstanceId}/highlights", method = RequestMethod.GET, produces = "application/json")
	public ObjectNode getHighlighted(@PathVariable String processInstanceId) {
	  ...
	  ObjectNode responseJSON = objectMapper.createObjectNode();
		...
		try {
			...
			HistoricProcessInstance hicprocessInstance =null;
			if(processInstance==null){
				hicprocessInstance =historyService.createHistoricProcessInstanceQuery().processInstanceId(processInstanceId).singleResult();
				...
				for (HistoricActivityInstance hai : hais) {
					activitiesArray.add(hai.getActivityId());
				}
				
				System.out.println("-----------------------");
				ProcessDefinition result = repositoryService.getProcessDefinition(hicprocessInstance.getProcessDefinitionId());
				ProcessDefinitionEntity processDefinition = (ProcessDefinitionEntity) repositoryService.getProcessDefinition(hicprocessInstance.getProcessDefinitionId());
				...
				responseJSON.put("processDefinitionId", hicprocessInstance.getProcessDefinitionId());
