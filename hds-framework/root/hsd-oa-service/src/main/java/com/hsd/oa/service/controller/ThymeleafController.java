package com.hsd.oa.service.controller;
...
import com.hsd.oa.service.service.ActivitiService;
import com.hsd.oa.service.service.UserService;
import com.hsd.oa.service.utils.JSONUtils;
...
public class ThymeleafController {
	...
	@ApiOperation(value = "我的待办", notes = "我的待办")
	public List<TaskVO> getmytasksfeign(
			@ApiParam(name = "userid", value = "用户id") @RequestParam(name = "userid") String userid
