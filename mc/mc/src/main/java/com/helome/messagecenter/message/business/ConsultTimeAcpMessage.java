...
public class ConsultTimeAcpMessage implements Message {

	public static final short CODE = 131;
	private final static Logger logger = LoggerFactory.getLogger(ConsultTimeAcpMessage.class);
	...
	public short getCode() {
		return ConsultTimeAcpMessage.CODE;
	}
	...
	public String toJson() {
		...
		try {
			...
			logger.error("ConsultTimeAcpMessage 消息异常："+e);
		}
		return str;
	}
