...
public class OpenMicMessage implements Message {

	public static final short CODE = 250;
	private final static Logger logger = LoggerFactory.getLogger(OpenMicMessage.class);
	...
	public String toJson() {
		...
		try {
			...
			logger.error("OpenMicMessage 异常："+e);
		}
		return str;
	}
