...
/**
 * @description 视频请求超时消息
 * @author beyond.zhang
 */
public class VideoTimeoutMessage implements Message {
	public static final short CODE = 213;
	private final static Logger logger = LoggerFactory.getLogger(VideoTimeoutMessage.class);
	...
	public VideoTimeoutMessage() {
		super();
	}

	public VideoTimeoutMessage(Long userId, String userName, Long inviteeId,
			String inviteeName) {
		this.userId = userId;
