...
public class OpenCameraMessage implements Message {

	public static final short CODE = 240;
	private final static Logger logger = LoggerFactory.getLogger(OpenCameraMessage.class);
	...
	public String toJson() {
		...
		try {
			...
			logger.error("OpenCameraMessage 异常："+e);
		}
		return str;
	}
