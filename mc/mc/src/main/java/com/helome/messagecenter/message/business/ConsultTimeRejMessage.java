...
public class ConsultTimeRejMessage implements Message {

	public static final short CODE = 132;
	private final static Logger logger = LoggerFactory.getLogger(ConsultTimeRejMessage.class);
	...
	public short getCode() {
		return ConsultTimeRejMessage.CODE;
	}
	...
	public String toJson() {
		...
		try {
			...
			logger.error("ConsultTimeRejMessage 消息异常："+e);
		}
		return str;
	}
