...
public class ConsultRejectMessage implements Message {
	private final static Logger logger = LoggerFactory.getLogger(ConsultRejectMessage.class);
	...
	public String toJson() {
		...
		try {
			...
			logger.error("ConsultRejectMessage 消息异常："+e);
		}
		return str;
	}
	...
	public void fromMap(Map<String, JsonNode> map) {
		...
		this.length =2+8+1+Utils.getUTF8StringLength(senderName)
				+8+1+Utils.getUTF8StringLength(receiverName)+6;
	}
