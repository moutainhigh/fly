...
/**
 * 
 * @description 接受结束咨询消息
 * @author beyond.zhang
 */
public class AcceptConsultEndMessage implements Message {
	public static final short CODE = 141;
	private final static Logger logger = LoggerFactory.getLogger(AcceptConsultEndMessage.class);
	...
	public String toJson() {
		...
		try {
			...
			logger.error("接受结束咨询消息code(141)异常："+e);
		}
		return str;
	}
