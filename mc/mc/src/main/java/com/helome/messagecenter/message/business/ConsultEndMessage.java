 ...
 * @author beyond.zhang
 */
public class ConsultEndMessage implements Message {

	public static final short CODE = 140;
	private final static Logger logger = LoggerFactory.getLogger(ConsultEndMessage.class);
