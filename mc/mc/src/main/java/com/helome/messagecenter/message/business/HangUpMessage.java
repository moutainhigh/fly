...
public class HangUpMessage implements Message {
	...
	private final static Logger logger = LoggerFactory.getLogger(HangUpMessage.class);
	...
	public void onReceived() {
		logger.debug("收到挂断消息 senderId {},receiverId {}",senderId,receiverId);
	...
	public String toJson() {
		...
		try {
			...
			logger.error("HangUpMessage 消息异常："+e);
		}
		return str;
	}
