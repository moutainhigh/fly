...
public class ConsultTimeMessage implements Message {

	public static final short CODE = 130;
	private final static Logger logger = LoggerFactory.getLogger(ConsultTimeMessage.class);
	...
	public short getCode() {
		return ConsultTimeMessage.CODE;
	}
	...
	public String toJson() {
		...
		try {
			...
			logger.error("ConsultTimeMessage 消息异常："+e);
		}
		return str;
	}
