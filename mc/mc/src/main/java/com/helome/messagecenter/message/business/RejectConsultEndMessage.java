...
/**
 * 
 * @description 拒绝结束咨询消息
 * @author beyond.zhang
 */
public class RejectConsultEndMessage implements Message {

	public static final short CODE = 142;
	private final static Logger logger = LoggerFactory.getLogger(RejectConsultEndMessage.class);
