 ...
 * @author beyond.zhang
 */
public class LackBalanceMessage implements Message {

	public static final short CODE = 150;
	private final static Logger logger = LoggerFactory.getLogger(LackBalanceMessage.class);
	...
	public short getCode() {
		return LackBalanceMessage.CODE;
	}
