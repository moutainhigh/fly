...
public class ConsultAcceptMessage implements Message {

	public static final short CODE = 131;
	private final static Logger logger = LoggerFactory.getLogger(ConsultAcceptMessage.class);
	...
	public short getCode() {
		return ConsultAcceptMessage.CODE;
	}
	...
	public String toJson() {
		...
		try {
            ...
            logger.error("ConsultAcceptMessage 异常："+e);
		}
		return str;
	}
