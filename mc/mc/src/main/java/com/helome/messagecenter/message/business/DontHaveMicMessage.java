...
public class DontHaveMicMessage implements Message {

	public static final short CODE = 252;
	private final static Logger logger = LoggerFactory.getLogger(DontHaveMicMessage.class);
	...
	public short getCode() {
		return DontHaveMicMessage.CODE;
	}
	...
	public void onReceived() {		
		logger.debug("收到没有MIC消息senderId {},receiverId {}",senderId,receiverId);
	...
	public String toJson() {
		...
		try {
			...
			logger.error("DontHaveMicMessage 消息异常："+e);
		}
		return str;
	}
