...
/**
 * @description 拒绝音频会话消息
 * @author beyond.zhang
 */
public class RejectAudioMessage implements Message {

	public static final short CODE = 222;
	private final static Logger logger = LoggerFactory.getLogger(RejectAudioMessage.class);
	...
	public void onReceived() {
		...
		if (fromEndpoints == null ) {
			...
			try {
				...
				logger.error("收到拒绝视频消息注销时发生异常",e);
			}
			if (toEndpoints != null) {
