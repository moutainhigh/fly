...
/**
 * @description 图片下载提醒消息
 * @version V1.0
 */
public class PictureDownLoadMessage implements Message{
	...
	public  short getCode() {
		return PictureDownLoadMessage.CODE;
	}
	...
	public ByteBuf toBinary() {
		...
		logger.debug("发送图片下载提醒消息from："+senderId+";to:"+receiverId);
		return buffer;
	}
