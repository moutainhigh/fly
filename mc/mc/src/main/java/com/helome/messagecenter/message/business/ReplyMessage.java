...
public class ReplyMessage implements Message {
	...
	private final static Logger logger = LoggerFactory.getLogger(ReplyMessage.class);
	...
	public void onReceived() {
		logger.info("收到评论回复消息 from {} to {} content: {}",senderId,receiverId,content);
	...
	public void fromMap(Map<String, JsonNode> map) {
		...
		this.length =  2+8+1+Utils.getUTF8StringLength(senderName)+8+1+Utils.getUTF8StringLength(receiverName)+6+2 +Utils.getUTF8StringLength(content);
	}
