...
public class RejectChatMessage implements Message {

	public static final short CODE = 107;
	private final static Logger logger = LoggerFactory.getLogger(RejectChatMessage.class);
	...
	public String toJson() {
		...
		try {
			...
			logger.error("RejectChatMessage 异常："+e);
		}
		return str;
	}
