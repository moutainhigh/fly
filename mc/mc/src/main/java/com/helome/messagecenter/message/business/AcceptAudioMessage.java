...
/**
 * @description 接受音频会话消息
 * @author beyond.zhang
 */
public class AcceptAudioMessage implements Message {

	public static final short CODE = 221;
	private final static Logger logger = LoggerFactory.getLogger(AcceptAudioMessage.class);
