...
public class TestInviteAudioMessage
{
  private SocketClient scoketClient;
  private Long senderId;
  private MessageMetaData messageMetaData;
  private MessageMetaData inviteAudioMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.inviteAudioMetaData = CommonsUtils.getInviteAudioMetaData(this.senderId, this.receiverId, "test", 1L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.inviteAudioMetaData);
