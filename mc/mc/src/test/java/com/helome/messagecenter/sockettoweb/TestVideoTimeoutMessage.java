...
public class TestVideoTimeoutMessage {
	private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData videoTimeoutMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    this.videoTimeoutMessageMetaData = CommonsUtils.getVideoTimeoutMetaData(this.senderId, this.receiverId, "test",1);
	...
	public void test() {
		try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.videoTimeoutMessageMetaData);
