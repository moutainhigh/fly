...
public class TestTxtMessage
{
    ...
    throws Exception
  {
    ...
    this.txtmessageMetaData = CommonsUtils.getTxtMetaData(this.senderId, this.receiverId, "test");
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.txtmessageMetaData);
