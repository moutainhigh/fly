...
public class TestLackBalanceMessage {
    ...
    private MessageMetaData lackBalancemessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    lackBalancemessageMetaData = CommonsUtils.getLackBalanceMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(lackBalancemessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(150);
