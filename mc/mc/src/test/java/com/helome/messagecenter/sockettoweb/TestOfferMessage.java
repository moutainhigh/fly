...
public class TestOfferMessage
{
  private SocketClient scoketClient;
  private Long senderId;
  private MessageMetaData messageMetaData;
  private MessageMetaData offermessageMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.offermessageMetaData = CommonsUtils.getOfferMetaData(this.senderId, this.receiverId, 1);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.offermessageMetaData);
