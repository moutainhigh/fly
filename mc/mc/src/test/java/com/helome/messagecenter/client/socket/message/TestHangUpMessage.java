...
public class TestHangUpMessage {
    ...
    private MessageMetaData hangUpmessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    hangUpmessageMetaData = CommonsUtils.getHangUpMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(hangUpmessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(260);
