...
public class TestLeaveChatMessage {
	 private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData leaveChatMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    leaveChatMessageMetaData = CommonsUtils.getLeaveChatMetaData(this.senderId, this.receiverId);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.leaveChatMessageMetaData);
