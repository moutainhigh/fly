...
public class TestChatMessage {
    ...
    private MessageMetaData chatMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    chatMetaData = CommonsUtils.getChatMetaData(senderId,senderId,"test");
	}
	...
	public void test() {
		try {
			...
			client.writeDate(chatMetaData);
			Thread.sleep(2000);
			client.readDateBlock(105);
