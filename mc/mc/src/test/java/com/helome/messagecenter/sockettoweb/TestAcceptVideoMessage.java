...
public class TestAcceptVideoMessage {
	private SocketClient scoketClient;
	  ...
	  private MessageMetaData acceptVideoMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    this.acceptVideoMetaData = CommonsUtils.getAcceptVideoMetaData(this.senderId, this.receiverId, "test",1);
	...
	public void test() {
		try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.acceptVideoMetaData);
