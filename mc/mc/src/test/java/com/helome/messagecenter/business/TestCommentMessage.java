...
public class TestCommentMessage {
	...
	public void setUp() throws Exception {
		uri = URI.create(CommonsUtils.getAddress());
	     ...
	     commentmap.put("code", 100);
	     commentmap.put("senderId", senderId);
	     commentmap.put("receiverId", senderId);
	     commentmap.put("senderName", "test:"+senderId);
	     commentmap.put("receiverName", "test:"+senderId);
	     commentmap.put("content", "comment:"+senderId);
	...
	public void test() {
		try {
			...
			CommentMessage receivedCommentMessage = (CommentMessage)msg;
			Assert.assertEquals("comment:"+senderId, receivedCommentMessage.getContent());
