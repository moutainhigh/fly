...
public class TestTransferMessage {
	...
	public void setUp() throws Exception {
		uri = URI.create(CommonsUtils.getAddress());
	     ...
	     commentmap.put("code", 110);
	     commentmap.put("senderId", senderId);
	     commentmap.put("receiverId", receiverId);
	     commentmap.put("senderName", "OpenCameraMessage:"+senderId);
	     commentmap.put("receiverName", "OpenCameraMessage:"+senderId);
	     commentmap.put("currency", 1);
	     commentmap.put("date", senderId);
	     commentmap.put("amount", 100);
