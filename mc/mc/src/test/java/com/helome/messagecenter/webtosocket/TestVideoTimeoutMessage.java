...
public class TestVideoTimeoutMessage {
	...
	public void setUp() throws Exception {
		uri = URI.create(CommonsUtils.getAddress());
	     ...
	     commentmap.put("code", 213);
	     commentmap.put("userId", senderId);
	     commentmap.put("inviteeId", receiverId);
	     commentmap.put("userName", "OpenCameraMessage:"+senderId);
	     commentmap.put("inviteeName", "OpenCameraMessage:"+senderId);
	     commentmap.put("sessionId", 1);
