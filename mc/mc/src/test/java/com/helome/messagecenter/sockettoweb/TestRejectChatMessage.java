...
public class TestRejectChatMessage {
	...
	public void setUp() throws Exception {
	    ...
	    rejectChatMessageMetaData = CommonsUtils.getRejectChatMetaData( this.receiverId);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, null, this.rejectChatMessageMetaData);
		      ...
		      socketSender.start();
		      Thread.sleep(5000L);
		      Message msg = MessageWareHouse.getById(receiverId);
