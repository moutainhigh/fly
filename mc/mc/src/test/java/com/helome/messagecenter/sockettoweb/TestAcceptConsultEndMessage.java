...
public class TestAcceptConsultEndMessage {
	private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData acceptConsultEndMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
		 this.scoketClient = new SocketClient("127.0.0.1", CommonsUtils.getSocketPort());
		    ...
		    this.acceptConsultEndMetaData = CommonsUtils.getAcceptConsultEndMetaData(this.senderId, this.receiverId, "test",1);
	...
	public void test() {
		try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.acceptConsultEndMetaData);
