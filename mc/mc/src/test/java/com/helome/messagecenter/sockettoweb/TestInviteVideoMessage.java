...
public class TestInviteVideoMessage
{
  private SocketClient scoketClient;
  private Long senderId;
  private MessageMetaData messageMetaData;
  private MessageMetaData inviteVideoMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.inviteVideoMetaData = CommonsUtils.getInviteVideoMetaData(this.senderId, this.receiverId, "test", 1L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.inviteVideoMetaData);
