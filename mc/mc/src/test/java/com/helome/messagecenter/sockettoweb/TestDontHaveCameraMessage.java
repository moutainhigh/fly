...
public class TestDontHaveCameraMessage
{
  ...
  private MessageMetaData dontHaveCameraMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.dontHaveCameraMetaData = CommonsUtils.getDontHaveCameraMetaData(this.senderId, this.receiverId, "test", 1L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.dontHaveCameraMetaData);
