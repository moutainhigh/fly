...
public class TestConsultAcceptMessage {
    ...
    private MessageMetaData consultAcceptmessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    consultAcceptmessageMetaData = CommonsUtils.getConsultAcceptMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(consultAcceptmessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(131);
