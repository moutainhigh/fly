...
public class TestRejectConsultEndMessage {
	...
	public void setUp() throws Exception {
	    ...
	    rejectConsultEndmessageMetaData = CommonsUtils.getRejectConsultEndMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(rejectConsultEndmessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(142);
