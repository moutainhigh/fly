...
public class TestCloseCameraMessage {
    ...
    private MessageMetaData closeCameraMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    closeCameraMetaData = CommonsUtils.getCloseCameraMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(closeCameraMetaData);
			Thread.sleep(2000);
			client.readDateBlock(241);
