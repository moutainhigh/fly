...
public class TestChatMessage {
	private SocketClient scoketClient;
	  ...
	  private MessageMetaData chatMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    this.chatMessageMetaData = CommonsUtils.getChatMetaData(this.senderId, this.receiverId, "test");
	...
	public void test() {
		try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.chatMessageMetaData);
