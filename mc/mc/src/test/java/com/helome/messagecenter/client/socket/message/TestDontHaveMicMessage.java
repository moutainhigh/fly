...
public class TestDontHaveMicMessage {
    ...
    private MessageMetaData dontHaveMicmessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    dontHaveMicmessageMetaData = CommonsUtils.getDontHaveMicMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(dontHaveMicmessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(252);
