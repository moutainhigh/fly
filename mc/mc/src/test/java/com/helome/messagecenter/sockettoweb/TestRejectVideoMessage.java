...
public class TestRejectVideoMessage {
	 private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData rejectVideoMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    rejectVideoMessageMetaData = CommonsUtils.getRejectVideoMetaData(this.senderId, this.receiverId,"test",1);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.rejectVideoMessageMetaData);
