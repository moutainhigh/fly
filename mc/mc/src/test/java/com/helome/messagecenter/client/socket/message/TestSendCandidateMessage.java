...
public class TestSendCandidateMessage {
    ...
    private MessageMetaData candidateMessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    candidateMessageMetaData = CommonsUtils.getSendCandidateMetaData(senderId,senderId,300);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(candidateMessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(232);
