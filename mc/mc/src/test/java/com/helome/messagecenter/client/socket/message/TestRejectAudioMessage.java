...
public class TestRejectAudioMessage {
	...
	public void setUp() throws Exception {
	    ...
	    rejectAudiomessageMetaData = CommonsUtils.getRejectAudioMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(rejectAudiomessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(222);
