...
public class TestAnswerMessage
{
  ...
  private MessageMetaData answermessageMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.answermessageMetaData = CommonsUtils.getAnswerMetaData(this.senderId, this.receiverId, 1);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.answermessageMetaData);
