...
public class TestOpenCameraMessage {
	 private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData openCameraMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    openCameraMessageMetaData = CommonsUtils.getOpenCameraMetaData(this.senderId, this.receiverId,"test",1);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.openCameraMessageMetaData);
