...
public class TestDontHaveMicMessage
{
  ...
  private MessageMetaData dontHaveMicMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.dontHaveMicMetaData = CommonsUtils.getDontHaveMicMetaData(this.senderId, this.receiverId, "test", 1L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.dontHaveMicMetaData);
