...
public class TestRejectVideoMessage {
	...
	public void setUp() throws Exception {
	    ...
	    rejectVideomessageMetaData = CommonsUtils.getRejectVideoMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(rejectVideomessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(212);
