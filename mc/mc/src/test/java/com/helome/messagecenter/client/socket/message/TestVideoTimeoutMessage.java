...
public class TestVideoTimeoutMessage {
	...
	public void setUp() throws Exception {
	    ...
	    videoTimeoutmessageMetaData = CommonsUtils.getVideoTimeoutMetaData(senderId,senderId,"test",1);
	...
	public void test() {
		try {
			...
			client.writeDate(videoTimeoutmessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(213);
