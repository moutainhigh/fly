...
public class TestOpenMicMessage {
	  private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData openMicMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    openMicMessageMetaData = CommonsUtils.getOpenMicMetaData(this.senderId, this.receiverId,"test",1);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.openMicMessageMetaData);
