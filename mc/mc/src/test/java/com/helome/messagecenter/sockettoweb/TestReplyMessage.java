...
public class TestReplyMessage {
	...
	public void setUp() throws Exception {
	    ...
	    this.replymessageMetaData = CommonsUtils.getCommonTxtMetaData(this.senderId, this.receiverId, "test",101);
	...
	public void test() {
		try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.replymessageMetaData);
