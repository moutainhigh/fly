...
public class TestRejectAudioMessage {
	 private SocketClient scoketClient;
	  ...
	  private MessageMetaData rejectAudioMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    rejectAudioMessageMetaData = CommonsUtils.getRejectAudioMetaData(this.senderId, this.receiverId,"test",1);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.rejectAudioMessageMetaData);
