...
public class TestAcceptAudioMessage {
    ...
    private MessageMetaData acceptAdoidMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    acceptAdoidMetaData = CommonsUtils.getAcceptAdoidMetaData(senderId,senderId,-1);
	}
	...
	public void test() {
		...
		try {
			...
			client.writeDate(acceptAdoidMetaData);
			Thread.sleep(2000);
			client.readDateBlock(221);
