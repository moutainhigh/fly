...
public class TestLeaveChatMessage {
    ...
    private MessageMetaData leaveChatMessage;
	...
	public void setUp() throws Exception {
		...
		leaveChatMessage = CommonsUtils.getLeaveChatMetaData(senderId,receiveId);
	...
	public void test() {
		try {
			...
			Thread.sleep(1000);
			SendThread sendThread= new SendThread(sendClient,sendMessageMetaData,leaveChatMessage);
			sendThread.start();
			Thread.sleep(1000);
			receiveClient.readDateBlock(108);
