...
public class TestAcceptAudioMessage {
	private SocketClient scoketClient;
	  ...
	  private MessageMetaData acceptAudioMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    this.acceptAudioMessageMetaData = CommonsUtils.getAcceptAdoidMetaData(this.senderId, this.receiverId, 1);
	...
	public void test() {
		try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.acceptAudioMessageMetaData);
