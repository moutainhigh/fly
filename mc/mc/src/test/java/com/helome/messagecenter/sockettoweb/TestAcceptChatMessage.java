...
public class TestAcceptChatMessage {
	private SocketClient scoketClient;
	  ...
	  private MessageMetaData acceptChatMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    this.acceptChatMessageMetaData = CommonsUtils.getAcceptChat(this.receiverId);
	...
	public void test() {
		try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, null, this.acceptChatMessageMetaData);
