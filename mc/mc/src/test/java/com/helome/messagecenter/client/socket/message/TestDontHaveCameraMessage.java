...
public class TestDontHaveCameraMessage {
    ...
    private MessageMetaData dontHaveCameramessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    dontHaveCameramessageMetaData = CommonsUtils.getDontHaveCameraMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(dontHaveCameramessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(242);
