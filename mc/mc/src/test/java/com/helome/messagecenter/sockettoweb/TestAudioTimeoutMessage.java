...
public class TestAudioTimeoutMessage {
	private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData audioTimeoutMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    this.audioTimeoutMessageMetaData = CommonsUtils.getAudioTimeoutMetaData(this.senderId, this.receiverId, "test",1);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.audioTimeoutMessageMetaData);
