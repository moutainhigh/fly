...
public class TestHangUpMessage
{
  private SocketClient scoketClient;
  private Long senderId;
  private MessageMetaData messageMetaData;
  private MessageMetaData hangUpMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.hangUpMetaData = CommonsUtils.getHangUpMetaData(this.senderId, this.receiverId, "test", 1L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.hangUpMetaData);
