...
public class TestLackTimeMessage {
	...
	public void setUp() throws Exception {
		uri = URI.create(CommonsUtils.getAddress());
	     ...
	     commentmap.put("code", 151);
	     commentmap.put("senderId", senderId);
	     commentmap.put("receiverId", senderId);
	     commentmap.put("senderName", "LackBalanceMessage:"+senderId);
	     commentmap.put("receiverName", "LackBalanceMessage"+senderId);
	     commentmap.put("date", new Date());
	     commentmap.put("consultId", senderId);
	     commentmap.put("left", 100);
