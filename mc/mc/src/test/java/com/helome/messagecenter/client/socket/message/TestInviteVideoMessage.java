...
public class TestInviteVideoMessage {
    ...
    private MessageMetaData inviteVideomessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    inviteVideomessageMetaData = CommonsUtils.getInviteVideoMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(inviteVideomessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(210);
