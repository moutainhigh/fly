...
public class TestConsultEndMessage
{
  ...
  private MessageMetaData consultEndMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.consultEndMetaData = CommonsUtils.getConsultEndMetaData(this.senderId, this.receiverId, "test", 100L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.consultEndMetaData);
