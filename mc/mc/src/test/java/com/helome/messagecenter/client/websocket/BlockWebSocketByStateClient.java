...
public class BlockWebSocketByStateClient {
    ...
    public BlockWebSocketByStateClient(URI uri,List<String> values, long id) {
        this.uri = uri;
        this.values = values;
        group = new NioEventLoopGroup();
        this.messageId = Long.valueOf(id);
    }
    ...
    public static void main(String[] args) throws Exception {
       ...
       // new BlockWebSocketByStateClient(uri,values).run();
    }
}
