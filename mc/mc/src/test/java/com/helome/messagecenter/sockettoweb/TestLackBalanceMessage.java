...
public class TestLackBalanceMessage
{
  private SocketClient scoketClient;
  private Long senderId;
  private MessageMetaData messageMetaData;
  private MessageMetaData lackBalanceMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.lackBalanceMetaData = CommonsUtils.getLackBalanceMetaData(this.senderId, this.receiverId, "test", 1L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.lackBalanceMetaData);
