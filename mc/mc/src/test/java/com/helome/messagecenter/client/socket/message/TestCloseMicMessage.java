...
public class TestCloseMicMessage {
    ...
    private MessageMetaData closeMicssageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    closeMicssageMetaData = CommonsUtils.getCloseMicMetaData(senderId,senderId,"test",1);
	...
	public void test() {
		try {
			...
			client.writeDate(closeMicssageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(251);
