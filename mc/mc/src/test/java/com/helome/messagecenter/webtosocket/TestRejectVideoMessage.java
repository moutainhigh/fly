...
public class TestRejectVideoMessage {
	...
	public void setUp() throws Exception {
		uri = URI.create(CommonsUtils.getAddress());
	     ...
	     commentmap.put("code", 212);
	     commentmap.put("userId", senderId);
	     commentmap.put("inviterId", receiverId);
	     commentmap.put("inviterName", "RejectVideoMessage:"+senderId);
	     commentmap.put("userName", "RejectVideoMessage:"+senderId);
