...
public class TestOnlineMessage {
	 private SocketClient scoketClient;
	  private Long senderId;
	  private MessageMetaData messageMetaData;
	  private MessageMetaData onlineMessageMetaData;
	  private URI uri;
	...
	public void setUp() throws Exception {
	    ...
	    onlineMessageMetaData = CommonsUtils.getOnlineMetaData(this.senderId, this.receiverId);
	...
	public void test() {
		 try {
		      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.onlineMessageMetaData);
