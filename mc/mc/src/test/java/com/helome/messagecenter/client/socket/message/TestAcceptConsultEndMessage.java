...
public class TestAcceptConsultEndMessage {
    ...
    private MessageMetaData acceptConsultEndmessageMetaData;
	@Before
	public void setUp() throws Exception {
	    ...
	    acceptConsultEndmessageMetaData = CommonsUtils.getAcceptConsultEndMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(acceptConsultEndmessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(141);
