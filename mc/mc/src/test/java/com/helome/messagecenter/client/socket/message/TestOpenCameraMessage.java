...
public class TestOpenCameraMessage {
	...
	public void setUp() throws Exception {
	    ...
	    openCameramessageMetaData = CommonsUtils.getOpenCameraMetaData(senderId,senderId,"test",1);
	}
	...
	public void test() {
		try {
			...
			client.writeDate(openCameramessageMetaData);
			Thread.sleep(2000);
			client.readDateBlock(240);
