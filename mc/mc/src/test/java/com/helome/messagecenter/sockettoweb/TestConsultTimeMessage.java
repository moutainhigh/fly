...
public class TestConsultTimeMessage
{
  ...
  private MessageMetaData consultTimeMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.consultTimeMetaData = CommonsUtils.getConsultTimeMetaData(this.senderId, this.receiverId, "test");
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.consultTimeMetaData);
