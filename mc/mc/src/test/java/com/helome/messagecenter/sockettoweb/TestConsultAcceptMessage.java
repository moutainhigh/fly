...
public class TestConsultAcceptMessage
{
  private SocketClient scoketClient;
  private Long senderId;
  private MessageMetaData messageMetaData;
  private MessageMetaData consultAcceptMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.consultAcceptMetaData = CommonsUtils.getConsultAcceptMetaData(this.senderId, this.receiverId, "test", 100L);
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.consultAcceptMetaData);
