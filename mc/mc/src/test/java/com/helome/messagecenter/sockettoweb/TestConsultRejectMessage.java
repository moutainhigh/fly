...
public class TestConsultRejectMessage
{
  ...
  private MessageMetaData consultRejectMetaData;
  private URI uri;
    ...
    throws Exception
  {
    ...
    this.consultRejectMetaData = CommonsUtils.getConsultRejectMetaData(this.senderId, this.receiverId, "test");
  ...
  public void test() {
    try {
      SocketThread socketSender = new SocketThread(this.scoketClient, this.messageMetaData, this.consultRejectMetaData);
