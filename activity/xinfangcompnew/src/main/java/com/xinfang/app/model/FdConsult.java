...
/**
 * 
 * @title FdConsult.java
 * @package com.xinfang.app.model
 * @description 咨询
 * @author ZhangHuaRong   
 * @update 2017年5月16日 下午2:37:35
 * @version V1.0  
 * Copyright (c)2012 chantsoft-版权所有
 */
@Entity
public class FdConsult {
...
//	private String suggest_text;
	...
	public Integer getConsult_status() {
		return consult_status;
	}
	public void setConsult_status(Integer consult_status) {
