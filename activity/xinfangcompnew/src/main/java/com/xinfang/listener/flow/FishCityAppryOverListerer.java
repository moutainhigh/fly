 ...
 */
@Component("fishCityAppryOverListerer")
public class FishCityAppryOverListerer implements TaskListener {
	...
	public void notify(DelegateTask task) {
		...
		//	Integer approval = (Integer) task.getVariable("approval");
			...
			Object processid =  task.getVariable("processid");
			 ApiLog.chargeLog1("==============流程控制===============fishCityAppryOverListerer==");
             System.out.println("==============流程控制===============fishCityAppryOverListerer==");
			...
			if(type==8){//退回
				...
				if(fcDwb.getDwType().intValue()==4 || fcDwb.getDwType().intValue()==8){//职能部门
					...
					maindep.setNote(HandleLimitState.forword.getName()+"(3)");
				}else{
