 ...
 */
@Component("appryRefuseListerer")
public class AppryRefuseListerer implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		try {
			...
			Object processid =   variables.get("processid");
			 ApiLog.chargeLog1("==============流程控制===============appryRefuseListerer==");
             System.out.println("==============流程控制===============appryRefuseListerer==");
			if(dep1!=null){//多次交办
