 ...
 */
@Component("forwordListerer")
public class ForwordListerer implements TaskListener {
	...
	public void notify(DelegateTask task) {
		...
		try {
			...
			Object processid =  task.getVariable("processid");
			 ApiLog.chargeLog1("==============流程控制===============forwordListerer==");
             System.out.println("==============流程控制===============forwordListerer==");
			if(approval<1){
