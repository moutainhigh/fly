...
*/  
    ...
    private static Float getlast(Date createTime, Date nowtime, Integer handleday) {
    ...
    public static String getDatePoorDay(Date nowDate,Date endDate) {
    ...
    public static void main(String[] args) {
       String str1 = "2017-01-11";
        String str2 = "2017-01-11" + " 10:59:59";
        try {
            Date d = strToDate(str1);
            Date d2 = strToDate2(str2);
           String ss = getDatePoorDay(d, d2);
