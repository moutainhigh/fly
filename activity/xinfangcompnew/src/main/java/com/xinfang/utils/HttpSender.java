...
public class HttpSender {
	...
	//@Value("${sms.url}")
	private static String smsurl="http://222.73.117.158/msg/";
//	@Value("${sms.account}")
	private static String smsaccount="vip_xfj";
	
	//@Value("${sms.pswd}")
	private static String smspswd="Tch123456";
	...
	public static String send(String phones,String msg) throws Exception{
		boolean needstatus = true;// 是否需要状态报告，需要true，不需要false
		String product = null;// 产品ID
		String extno = null;// 扩展码
		String returnString = HttpSender.batchSend(smsurl, smsaccount, smspswd, phones, msg, needstatus, product, extno);
		return returnString;
	}
}
