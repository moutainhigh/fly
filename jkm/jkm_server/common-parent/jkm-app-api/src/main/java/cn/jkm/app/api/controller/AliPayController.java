...
import cn.jkm.eb.pay.alipay.util.AlipayUtil;
import cn.jkm.eb.pay.alipay.util.DatetimeUtil;
import cn.jkm.eb.pay.alipay.util.PayUtil;
import cn.jkm.eb.pay.alipay.util.SerializerFeatureUtil;
import cn.jkm.eb.pay.alipay.util.StringUtil;
import cn.jkm.eb.pay.alipay.util.WebUtil;
...
import cn.jkm.eb.pay.alipay.model.JsonResult;
import cn.jkm.eb.pay.alipay.model.ResponseData;

/**
 * 创建时间：2017年06月16日 15:23:32
 * @author xeh
 * @version 1.0
 */
@Controller
