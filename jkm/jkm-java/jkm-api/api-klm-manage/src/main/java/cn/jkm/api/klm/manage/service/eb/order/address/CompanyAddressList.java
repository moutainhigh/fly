 ...
 */
@Component("companyAddressList1.0")
@NotNull(name = {"type","limit","page"}, message = "缺少参数")
public class CompanyAddressList extends AbstractManageService {
    ...
    public Map service(Map request) {
        ...
        List<UserAddress> userAddressList = addressService.queryCompanyAddress(
