 ...
 */
@Component("splashList1.0")
@NotNull(name = {"limit","page"}, message = "缺少参数")
public class SplashList extends AbstractManageService{
    ...
    public Map service(Map request) {
        ListResult<SettingBanner> result = bannerService.findSplashWithCount(limit(request),page(request));
