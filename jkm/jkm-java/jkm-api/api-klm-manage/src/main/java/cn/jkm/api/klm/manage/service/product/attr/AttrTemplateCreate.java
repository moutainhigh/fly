 ...
 */
@Component("attrTemplateCreate1.0")
@NotNull(name = {"json"}, message = "缺少参数")
public class AttrTemplateCreate extends AbstractManageService {
    ...
    public Map service(Map request) {
        ...
        return ApiResponse.success().body(attrTemplateService.addAttrTemplate(module));
    }
}
